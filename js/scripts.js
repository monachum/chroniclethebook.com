$(function () {
    ...
    $("#mailchimp-subscribe").ajaxChimp({
        ...
        url: "https://Chroncast.us17.list-manage.com/subscribe/post?u=c6a236784bf29da7e34df1b1e&amp;id=cac199b7e4"
    ...
    function mailchimpCallback(resp) {
        if (resp.result === 'success') {
            ...
            $('.subscription-success')
                .html('<i class="fa fa-check-circle"></i>' + "&nbsp;" + 'Thank you for subscribing!')
                .delay(500)
                .fadeIn(1000);
